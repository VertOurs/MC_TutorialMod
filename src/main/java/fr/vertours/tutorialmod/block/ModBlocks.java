package fr.vertours.tutorialmod.block;

import fr.vertours.tutorialmod.TutorialMod;
import fr.vertours.tutorialmod.item.ModItemGroup;
...
public class ModBlocks {
    ...
    public static final Block RAW_MYTHRIL_BLOCK = registerBlock(
            "raw_mythril_block",
            new Block(FabricBlockSettings.of(Material.STONE).strength(4.5f).requiresTool()),
            ModItemGroup.MYTHRIL
    );
